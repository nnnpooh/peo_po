        ...
        <div className='codatamodalBackground'>
            <div className='codatamodalContainer'>
                <div className='codatatitleCloseBtn'>
                    <button onClick={() => closecoModal(false)}>X</button>
                </div>
                ...
                <div className='body'>
                    ...
                    <label>CO Learning Method</label>
                    <br />
                    <textarea
                        htmlFor='po'
                        id='po'
                        value={colearnMethod}
                        onChange={handleLearnmethod}
                        style={{ width: '300px', height: '50px' }}
                    ></textarea>
                    ...
                    <label>CO Evaluation Method</label>
                    <br />
                    <textarea
                        htmlFor='po'
                        id='po'
                        value={coevalMethod}
                        onChange={handleEvalmethod}
                        style={{ width: '300px', height: '50px' }}
                    ></textarea>
                ...
                <div className='footer'>
                    <button
                        onClick={(event) =>
                            submitNumberco(event, coMapping) && closecoModal(false)
                        }
                    >
                        Add CO Detail
                    </button>
